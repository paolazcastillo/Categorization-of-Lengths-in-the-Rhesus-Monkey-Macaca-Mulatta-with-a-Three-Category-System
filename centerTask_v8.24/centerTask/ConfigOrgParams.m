classdef ConfigOrgParams
    ...
    methods (Static)
        function orgParams = getTaskDefaults()
            ...
            % CenterConsole.m reads both when it builds its "Alternate:
            % blocks/segment" fields, so they must exist here (v8.23 dropped
            % them and the console failed to construct; restored in v8.24).
