    ...
    methods
        ...
        function buildTaskParamsPanel(self)
            ...
            self.ui.popStimulusSet = uicontrol('Parent', p, 'Style', 'popupmenu', ...
                ...
                'category''s midpoint, and the longest bar (4.00 / 5.85 / 7.80 deg VA) -- the ' ...
                'widest separation the stimulus table allows, i.e. the easiest discrimination, for ' ...
                'a first session above the training phases.']);
