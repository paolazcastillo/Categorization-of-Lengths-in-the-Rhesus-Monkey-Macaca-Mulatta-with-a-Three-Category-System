...
% =====================================================================
%  (a)  Trial-level model: cognitive model vs tiny RNN, with s_t added
% =====================================================================
...
\begin{scope}[xshift=6.6cm]
  \node[font=\sffamily\large] at (2.6, 1.3) {Tiny recurrent network};
...
\node[align=left, anchor=north west, font=\sffamily\small, text=black!70] at (-1.6,-6.0) {%
  ...
  \colorbox{catShort!55}{$s_t$}: \textbf{current} bar length (deg VA), the input the original tasks do not have \quad
  $d \in \{1,\dots,4\}$ \quad
  $P(a_t)$: probability over \{Short, Mid, Long\}
};

% =====================================================================
%  (b)  Task structure of CenterTask, drawn like the reversal / two-stage tasks
% =====================================================================
\begin{scope}[yshift=-8.6cm]
\node[font=\sffamily\bfseries\Large, anchor=west] at (-2.2,1.1) {b};
\node[font=\sffamily\large, anchor=west] at (-1.0,1.1) {Length categorization task (CenterTask, three categories)};
...
\begin{scope}[xshift=0.0cm, yshift=-6.6cm]
  ...
  \node[font=\sffamily\scriptsize, text=black!60] at (1.8,1.7) {category rule: fixed, no reversal};
\end{scope}
