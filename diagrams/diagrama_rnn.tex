...
\begin{scope}[xshift=6.6cm]
  \node[font=\sffamily\large] at (2.6, 1.3) {Red recurrente diminuta};
...
\node[align=left, anchor=north west, font=\sffamily\small, text=black!70] at (-1.6,-6.0) {%
  ...
  \colorbox{orange!25}{$s_t$}: longitud de la barra \textbf{actual} (deg VA), la entrada que no está en la tarea original \quad
  $d \in \{1,\dots,4\}$ \quad
