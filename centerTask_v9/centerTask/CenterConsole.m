    ...
    methods
        ...
        function buildTaskParamsPanel(self)
            ...
            self.ui.chkCenterInReach = uicontrol('Parent', p, 'Style', 'checkbox', ...
                ...
                '(Min target hold field) before reward. Position is drawn from the weights below. ' ...
                'Reach timeout is orgParams.targetDuration (ConfigOrgParams.m, default 5s) -- NOT ' ...
                'editable from this console; there is no "Target timeout" field despite what an older ' ...
                'version of this tooltip said. Off = pure hold-in-centre for reward.']);
